      ...
      <div class="register-card">
        ...
        <form class="register-form" (ngSubmit)="onRegister()" *ngIf="!isLoading; else loading">
          ...
          <div class="form-group" *ngIf="user.role === 'staff'">
            ...
            <input type="text" id="department" [(ngModel)]="user.department" name="department" 
...
export class RegisterComponent {
  ...
  isFormValid(): boolean {
    const basicValid = !!this.user.name && 
                      !!this.user.email && 
                      !!this.user.role && 
                      !!this.user.password && 
    ...
    if (this.user.role === 'staff') {
      return basicValid && !!this.user.department && this.user.password === this.confirmPassword;
    }
  ...
  onRegister() {
    ...
    if (this.user.role === 'staff' && this.user.department) {
      registerData.department = this.user.department;
    }
